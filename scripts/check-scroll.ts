...
async function checkScroll() {
  ...
  const pagesToCheck = ['/laglistor', '/dashboard', '/browse/lagar']
  ...
  for (const pageUrl of pagesToCheck) {
    ...
    console.log(
      ...
      bodyWidth > windowWidth || htmlWidth > windowWidth
    )
    ...
    if (bodyWidth > windowWidth || htmlWidth > windowWidth) {
      ...
      await page.screenshot({
        path: 'scroll-check-' + pageUrl.replace(/\//g, '-') + '.png',
        fullPage: false,
      })
    }
  }
  ...
  if (await tableToggle.isVisible()) {
    ...
    if (bodyWidth > windowWidth) {
      ...
      await page.screenshot({
        path: 'scroll-check-table-view.png',
        fullPage: false,
      })
    }
  }
