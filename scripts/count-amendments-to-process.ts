...
async function main() {
  ...
  console.log('')
  console.log('Estimated cost (~$0.02 per doc):', '$' + (needsProcessing * 0.02).toFixed(2))
  console.log('')
  console.log('To prepare the batch, run:')
  console.log('  pnpm tsx scripts/batch-process-amendments.ts prepare --limit ' + needsProcessing)
