...
async function captureModalScreenshots() {
  ...
  try {
    ...
    await page.screenshot({
      path: 'test-results/screenshots/modal-1-page.png',
      fullPage: false,
    })
    ...
    await page.screenshot({
      path: 'test-results/screenshots/modal-2-empty-search.png',
      fullPage: false,
    })
    ...
    await page.screenshot({
      path: 'test-results/screenshots/modal-3-search-results.png',
      fullPage: false,
    })
    ...
    await page.waitForTimeout(1000)
    await page.screenshot({
      path: 'test-results/screenshots/modal-4-long-titles.png',
      fullPage: false,
    })
    ...
    await page.screenshot({
      path: 'test-results/screenshots/modal-5-browse-tab.png',
      fullPage: false,
    })
    ...
    await page.screenshot({
      path: 'test-results/screenshots/modal-error.png',
      fullPage: false,
    })
  } finally {
    await browser.close()
