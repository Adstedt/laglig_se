...
import { warmDocumentCache, getDocumentCacheStats } from '@/lib/services/document-cache'
...
async function main() {
  ...
  console.log(`   Estimated size: ${(statsBefore.estimatedSize / 1024 / 1024).toFixed(2)} MB\n`)
  ...
  console.log(`   Estimated size: ${(statsAfter.estimatedSize / 1024 / 1024).toFixed(2)} MB`)
  console.log(`   New documents cached: ${statsAfter.cachedDocuments - statsBefore.cachedDocuments}`)
