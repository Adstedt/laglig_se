...
interface WorkspaceEuPageProps {
...
export default async function WorkspaceEuPage({
  searchParams,
}: WorkspaceEuPageProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Search Bar */}
      <CatalogueSearchBar initialQuery={query} basePath="/browse/eu" />
