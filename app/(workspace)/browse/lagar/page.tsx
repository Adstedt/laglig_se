...
interface WorkspaceLagarPageProps {
...
export default async function WorkspaceLagarPage({
  searchParams,
}: WorkspaceLagarPageProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Search Bar */}
      <CatalogueSearchBar initialQuery={query} basePath="/browse/lagar" />
