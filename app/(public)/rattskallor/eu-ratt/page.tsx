...
export default async function EuRattPage({ searchParams }: EuRattPageProps) {
    ...
    <div className="container mx-auto px-4 py-8 md:py-12">
      ...
      <div className="flex gap-8">
        ...
        <main className="min-w-0 flex-1">
          ...
          <Suspense fallback={<EuRattResultsSkeleton />}>
            <CatalogueResults
              query={query}
...
function EuRattResultsSkeleton() {
  return (
