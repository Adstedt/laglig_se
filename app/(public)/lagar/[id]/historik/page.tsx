      ...
      <div className="container mx-auto max-w-4xl px-4 py-6">
        ...
        <Breadcrumb className="mb-6">
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbLink href={`/lagar/${slug}`}>
                {law.document_number}
              </BreadcrumbLink>
            </BreadcrumbItem>
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbPage>Ändringshistorik</BreadcrumbPage>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
          ...
          <div className="flex gap-3">
            ...
            <div className="text-sm text-blue-800 dark:text-blue-200">
              ...
              <p className="text-blue-700 dark:text-blue-300">
                Klicka på en ändringsförfattning för att se exakt vilka
                paragrafer som ändrades jämfört med föregående version.
              </p>
            </div>
          </div>
        </div>
        ...
        <footer className="text-center text-sm text-muted-foreground py-4 border-t">
          <p>
            Ändringshistorik baserad på insamlade ändringsförfattningar från
            1998 och framåt.
          </p>
        </footer>
      </div>
