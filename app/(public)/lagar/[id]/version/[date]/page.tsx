...
export default async function HistoricalVersionPage({ params }: PageProps) {
      ...
      <div className="container mx-auto max-w-4xl px-4 py-6">
        ...
        <Breadcrumb className="mb-6">
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbPage>Version {formattedDate}</BreadcrumbPage>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
        ...
        <Card className="mb-6">
          <CardContent className="p-4">
            ...
            {/* Navigation to compare versions */}
