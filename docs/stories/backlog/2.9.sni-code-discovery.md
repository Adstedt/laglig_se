...
> **Note (2026-03-16):** ACs 6-8 (Bolagsverket integration) superseded by Epic 15 (BolagsAPI Integration). ACs 1-5 (SNI reference data) moved to Story 15.3. Remaining scope — law list mapping (ACs 13-16), discovery UI (ACs 17-22), and analytics (ACs 23-26) — stays in backlog as future work.
...
| 2026-03-16 | 2.1     | ACs 1-8 superseded by Epic 15 (Stories 15.1, 15.3). Remaining ACs in backlog.      | Sarah (PO) |
