...
// Solo: €399/month
// Team: €899/month
// Enterprise: €2,000/month (custom pricing)
```
...
async function handlePaymentFailed(invoice: Stripe.Invoice) {
  ...
  console.log(`Payment failed for workspace ${workspace.id}, 3-day grace period`)
}
      ...
      <Body style={styles.body}>
        <Container style={styles.container}>
          ...
          <Text style={styles.text}>
            Your payment of €{amount.toFixed(2)} for Laglig.se failed to process.
          </Text>
...
- Grace period expires → workspace paused
