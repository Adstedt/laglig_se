...
- [~] **19.4** — Entity-read tools (lazy traversal) — 🔬 **READY FOR REVIEW 2026-05-24** (`docs/stories/19.4.entity-read-tools.md`, v0.4; implemented, +15 tests, full unit suite green, no migration) — pending review + live traversal smoke
