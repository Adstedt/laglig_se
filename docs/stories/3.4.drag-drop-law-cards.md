...
test.describe('Law Card Drag and Drop', () => {
  test('drag law card into chat adds context', async ({ page }) => {
    ...
    await expect(page.locator('[data-testid="context-pill"]')).toContainText('Arbetsmiljölagen')
  })
  ...
  test('mobile: tap to add context', async ({ page }) => {
    ...
    await page.locator('[data-testid="law-card-1"] button:has-text("Add to context")').click()
