...
Archived — Superseded by Epic 14 (Stories 14.2 + 14.3). Chunking strategy decided architecturally (three-tier paragraf-level chunking) rather than through experimental comparison. Retrieval quality benchmarked via Cohere Rerank v4 in Story 14.3 (+38% relevance improvement).
