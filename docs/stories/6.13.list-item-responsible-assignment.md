...
- [ ] Add responsible_user_id to list_items table
- [ ] Build responsible person selector component
- [ ] Display in Legal Document Modal header
- [ ] Add avatar column to Law List table
- [ ] Add "Responsible" filter to Law List
- [ ] Trigger notification on assignment
- [ ] Set up weekly summary email for responsible persons
