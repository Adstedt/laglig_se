...
- [Laglig.se Fullstack Architecture Document](#table-of-contents)
  ...
  - [SFS Sync System](./sfs-sync-system.md)
    - [System Architecture](./sfs-sync-system.md#system-architecture)
    - [Cron Job Schedule](./sfs-sync-system.md#cron-job-schedule)
    - [sync-sfs-updates Flow](./sfs-sync-system.md#sync-sfs-updates-flow-amendment-detection)
    - [Amendment Detection](./sfs-sync-system.md#amendment-detection-full-text-vs-undertitel)
    - [Database Schema](./sfs-sync-system.md#database-schema-sync-related-tables)
    - [Retry Mechanism](./sfs-sync-system.md#retry-mechanism)
    - [Key Source Files](./sfs-sync-system.md#key-source-files)
    - [Monitoring & Observability](./sfs-sync-system.md#monitoring--observability)
