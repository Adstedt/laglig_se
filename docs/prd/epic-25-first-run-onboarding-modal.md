...
- "Fortsätt utforska" secondary CTA on all three done steps transitions modal to `tutorial_only` mode (B.5 dependency for the mode rendering — defer that until after B.5)
