...
- [Laglig.se Product Requirements Document (PRD)](#table-of-contents)
  ...
  - [User Interface Design Goals](./user-interface-design-goals.md)
    ...
    - [Key Interaction Paradigms](./user-interface-design-goals.md#key-interaction-paradigms)
      ...
      - [3. Kanban-Style Compliance Workspace](./user-interface-design-goals.md#3-kanban-style-compliance-workspace)
  ...
  - [Epic 6: Compliance Workspace (Kanban + Dashboard) (DETAILED)](./epic-6-compliance-workspace-kanban-dashboard-detailed.md)
    - [Story 6.1: Build Dashboard Summary View](./epic-6-compliance-workspace-kanban-dashboard-detailed.md#story-61-build-dashboard-summary-view)
    - [Story 6.2: Create Kanban Compliance Workspace](./epic-6-compliance-workspace-kanban-dashboard-detailed.md#story-62-create-kanban-compliance-workspace)
    - [Story 6.3: Implement Law Card Modal (Detailed View)](./epic-6-compliance-workspace-kanban-dashboard-detailed.md#story-63-implement-law-card-modal-detailed-view)
    - [Story 6.4: Add Task Management to Law Cards](./epic-6-compliance-workspace-kanban-dashboard-detailed.md#story-64-add-task-management-to-law-cards)
    - [Story 6.5: Implement Drag-and-Drop for Kanban Board](./epic-6-compliance-workspace-kanban-dashboard-detailed.md#story-65-implement-drag-and-drop-for-kanban-board)
    - [Story 6.6: Add Filtering and Search to Kanban](./epic-6-compliance-workspace-kanban-dashboard-detailed.md#story-66-add-filtering-and-search-to-kanban)
    - [Story 6.7: Implement Kanban Column Customization](./epic-6-compliance-workspace-kanban-dashboard-detailed.md#story-67-implement-kanban-column-customization)
    - [Story 6.8: Add Bulk Actions to Kanban](./epic-6-compliance-workspace-kanban-dashboard-detailed.md#story-68-add-bulk-actions-to-kanban)
    - [Story 6.9: Implement Global Search (Cmd+K)](./epic-6-compliance-workspace-kanban-dashboard-detailed.md#story-69-implement-global-search-cmdk)
    - [Story 6.10: Add Export Kanban Board as PDF/Image](./epic-6-compliance-workspace-kanban-dashboard-detailed.md#story-610-add-export-kanban-board-as-pdfimage)
