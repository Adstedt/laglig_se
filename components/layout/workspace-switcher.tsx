...
export function WorkspaceSwitcher({
  ...
  // Collapsed: centered square button with just the avatar
  if (collapsed) {
    if (!mounted) {
      return (
        <button className="mx-auto flex h-9 w-9 items-center justify-center rounded-lg transition-colors hover:bg-accent">
