...
export function NotYetInForceBanner({ effectiveDate }: NotYetInForceBannerProps) {
  return (
      ...
      <div className="flex gap-3">
        ...
        <div>
          <h4 className="text-orange-800 dark:text-orange-200 font-semibold text-sm">
            Denna lag har ännu inte trätt i kraft
          </h4>
          <p className="text-orange-700 dark:text-orange-300 text-sm mt-1">
            Lagen träder i kraft den <strong>{effectiveDate}</strong>.
            Innehållet visar den beslutade lydelsen som kommer att gälla från ikraftträdandet.
          </p>
        </div>
      </div>
    </div>
