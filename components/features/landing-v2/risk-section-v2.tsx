...
const risks = [
  {
    ...
    description:
      'GDPR, arbetsmiljö, branschkrav... Landskapet är enormt – och unikt för varje företag.',
    stat: '10 000+',
    statLabel: 'lagar & föreskrifter',
  },
  {
    icon: RefreshCw,
    ...
    <section className="relative border-y bg-gradient-to-b from-stone-50 to-stone-100/50 py-16 dark:from-stone-950/50 dark:to-stone-900/30 md:py-24">
      ...
      <div className="container relative mx-auto px-4">
        <div className="mx-auto mb-12 max-w-3xl text-center md:mb-16">
          <div
            className="mb-4 inline-flex items-center gap-2 rounded-full bg-amber-100 px-4 py-1.5 text-sm font-medium text-amber-800 dark:bg-amber-900/30 dark:text-amber-200"
