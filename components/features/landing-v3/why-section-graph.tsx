          ...
          <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-12 lg:gap-14">
            ...
            <div className="lg:col-span-7">
              <div className="relative overflow-hidden rounded-3xl border bg-gradient-to-b from-card/30 to-section-warm/0 p-5 shadow-[0_1px_0_0_rgb(0_0_0_/_0.02),0_12px_32px_-16px_rgb(0_0_0_/_0.10)] backdrop-blur-sm md:p-7">
                {/* On phones the desktop scatter is rendered at a fixed design
                    width and scaled down to fit (centred, edges softened by the
                    radial mask); lg+ keeps the fluid full-width pile. */}
                <div className="relative mx-auto h-[340px] overflow-hidden lg:h-auto lg:overflow-visible">
                  <div className="absolute left-1/2 top-0 w-[600px] origin-top -translate-x-1/2 scale-[0.55] lg:static lg:left-auto lg:w-full lg:translate-x-0 lg:scale-100">
                    <div ref={pileRef} className="relative min-h-[620px]">
                      ...
                      >
                        <div
                          className={cn(CARD, 'flex w-[201px] overflow-hidden')}
                        >
                      ...
                      >
                        <div
                          className={cn(CARD, 'relative w-[227px] px-4 py-3.5')}
                        >
                          {/* folded corner */}
                      ...
                      >
                        <div
                          className={cn(CARD, 'relative w-[207px] px-4 py-3.5')}
                        >
